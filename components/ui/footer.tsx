        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; Easeport.org - All rights reserved.
            </div>
          </div>
            ...
            <ul className="flex">
              <li>
                <Link
                  ...
                  href="https://www.linkedin.com/in/maksym-yuzefovych/"
                  aria-label="LinkedIn"
                >
                  <svg
                    className="h-8 w-8"
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://github.com/maksyuze456"
                  aria-label="Github"
                >
                  <svg
