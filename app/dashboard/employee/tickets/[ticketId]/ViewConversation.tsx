...
import { TicketMessage, Ticket } from "../../../../_types/tickets";
...
export default function ConversationTable({
  { singleTicket, isTicketLoading },
  { ticketConversation, isConversationLoading },
  onSuccess,
  onCloseTicket,
}: ConversationTableProps: ConversationTableProps) {
  ...
  return (
    <Box style={{ height: "700px", padding: "16px" }}>
      <Paper shadow="xs" p="md">
        ...
        <ScrollArea h={500} offsetScrollbars viewportRef={scrollRef}>
          <div
          ...
          >
            {ticketConversation?.map((message: TicketMessage) => {
              ...
              const repliedTo = ticketConversation.find(
                (m: TicketMessage) => m.emailMessageId === message.inReplyTo
              );
              return (
                <div
                  key={message.ticketMessageId}
        ...
        <Paper shadow="xs" p="md" mt="md">
          ...
          <form onSubmit={form.onSubmit(handleSubmit)}>
            ...
            <Flex justify="flex-end" gap="md" mt="md">
              ...
              <Button type="submit" size="sm" radius="md" disabled={isClosed}>
                Send Response
              </Button>
            </Flex>
          </form>
